          ...
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            <div className="d-flex flex-row align-items-start justify-content-between mb-3">
              <div class="d-flex flex-column">
                ...
                <div className="d-flex flex-row align-items-center">
                  ...
                  <Form.Control type="date"  onChange={(event) => this.editField(event)} style={{
                      maxWidth: '160px'
                    }} required="required"/>
                </div>
              </div>
            ...
            <Row className="mb-5">
              <Col>
                ...
                <Form.Control placeholder={"Phone No"} value={this.state.billToPhone_No} type="tel" name="billToPhone_No" className="my-2"  autoComplete="tel" onChange={(event) => this.editField(event)}  required="required"/>
              ...
              <Col>
                ...
                <Form.Control placeholder={"Who is this invoice from?(Company's Name)"} rows={3} value={this.state.billFrom} type="text" name="billFrom" className="my-2" onChange={(event) => this.editField(event)} autoComplete="name" required="required"/>
                <Form.Control placeholder={"GSTIN NO."} rows={3} value={this.state.billFromGstin} type="text" name="billFromGstin" className="my-2" onChange={(event) => this.editField(event)} autoComplete="Gstin NO." />
                ...
                <Form.Control placeholder={"Phone No"} value={this.state.billFromPhone_No} type="tel" name="billFromPhone_No" className="my-2"  onChange={(event) => this.editField(event)} autoComplete="tel" required="required"/>
                <Form.Control placeholder={"Address"} value={this.state.billFromAddress} type="text" name="billFromAddress" className="my-2" autoComplete="address" onChange={(event) => this.editField(event)} required="required"/>
              </Col>
            </Row>
            ...
            <Form.Control placeholder="Any Relevat Information!" name="notes" value={this.state.notes} onChange={(event) => this.editField(event)} as="textarea" className="my-2" rows={1}/> */}
            <Form.Label className="fw-bold">Terms & Conditions:</Form.Label>
            <Form.Control placeholder="Thanks for doing business with us!" name="notes" value={this.state.notes} onChange={(event) => this.editField(event)} as="textarea" className="my-2" rows={1}/>
          </Card>
        </Col>
        <Col md={4} lg={3}>
