      ...
      <div>
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          <div id="invoiceCapture">
            <div className="d-flex flex-row justify-content-between align-items-start text-white bg-dark w-90 p-4">
              <div className="w-80">
                <h2 className="fw-bold my-2">INVOICE</h2>
                {/* <h4 className="fw-bold my-2">{this.props.info.billFrom||'Abhinav Goyal'}</h4> */}
                <h5 className="fw-bold  mb-1">
                  Invoice No :#INV-0{this.props.info.invoiceNumber||''}
                </h5>
                <h6>
                <div className="fw-bold mt-2">Date Of Issue: {this.props.info.dateOfIssue||''}</div>
                 
                </h6>
              </div>
              <div className="text-end ms-4">
                <h4 className="fw-bold mt-6 mb-2">Amount&nbsp;Due:</h4>
                <h5 className="fw-bold text-white"> {this.props.currency} {this.props.total}</h5>
              </div>
            </div>
            <div className="p-4">
              <Row className="mb-4">
                <Col md={6}>
                  ...
                  <div>{this.props.info.billToPhone_No||''}</div>
                ...
                <Col md={6}>
                  ...
                  <div>{this.props.info.billFromGstin||''}</div>
                  <div>{this.props.info.billFromPhone_No||''}</div>
